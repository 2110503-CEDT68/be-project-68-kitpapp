...
const {getRestaurants, getRestaurant, createRestaurant, updateRestaurant, deleteRestaurant} = require('../controllers/restaurant');
...
router.use('/:restaurantlId/appointments/',appointmentRouter);
